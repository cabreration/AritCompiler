 ...
 * @author jacab
 */
public class Median implements Instruction {
    ...
    public Median(Expression vector, Expression trim, int line, int column) {
        this.vector = vector;
        this.trim = trim;
        this.line = line;
        this.column = column;
    ...
    public Median(Expression vector, int line, int column) {
        this.vector = vector;
        this.line = line;
        this.column = column;
        this.trim = null;
    ...
    public Object process(SymbolsTable env) {
        ...
        if (this.trim == null) {
            return calculateMedian((Vector)vec, 0, false);
        }
        else {
            ...
            return calculateMedian((Vector)vec, trimmer, true);
        }
    }
